...
for ($i=0; $i<count($cart); $i++) { 
 ...
 $iddd = $cart[$i]['id'];
 $query = mysqli_query($conn, "INSERT INTO pesanan (jumlah_pesanan, total_harga, tanggal, id_pelanggan, id_minuman) VALUES ('$total_item', '$total_bayar', '" . date('Y-m-d') . "','$dpp', '$iddd')");
}
