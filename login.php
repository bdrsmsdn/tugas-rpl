...
?>
        ...
        <div class="form-group">
          <div class="custom-control custom-checkbox">
            ...
            <a href="login-staff.php" class="staff float-left"> Login as staff </a>
          </div>
        </div>
        ...
        <div class="mt-4 text-center">Tidak mempunyai akun? <a href="auth-register.html">Ayo buat!</a></div>
      </form>
    </div>
